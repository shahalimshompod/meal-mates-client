...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/add-food',
        element: <ProtectPrivateRoutes><AddFood></AddFood></ProtectPrivateRoutes>,
        loader: () => {
      ...
      },
      {
        ...
        element: <ProtectPrivateRoutes><ManageMyFoods></ManageMyFoods></ProtectPrivateRoutes>,
        loader: () => {
      ...
      },
      {
        ...
        element: <ProtectPrivateRoutes><MyFoodRequests></MyFoodRequests></ProtectPrivateRoutes>,
        loader: () => {
      ...
      },
      {
        ...
        element: <ProtectPrivateRoutes><FoodDetails></FoodDetails></ProtectPrivateRoutes>,
        loader: ({ params }) => {
          document.title = 'Food Details - Meal Mates';
          return fetch(`https://my-assignment-11-server-pi.vercel.app/food-details/${params.id}`)
        }
      }
    ]
  },
